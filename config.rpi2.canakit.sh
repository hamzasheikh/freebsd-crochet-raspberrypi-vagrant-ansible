...
#option ImageSize 30000mb # for 4 Gigabyte card
...
customize_freebsd_partition ( ) {
    ...
    echo "ifconfig_ue0_ipv6=\"inet6 accept_rtadv\"" >> etc/rc.conf
    echo "rtsold_enable=\"YES\"" >> etc/rc.conf
    echo "wlans_run0=\"wlan0\"" >> etc/rc.conf
    echo "ifconfig_wlan0=\"WPA SYNCDHCP\"" >> etc/rc.conf
    echo "ifconfig_wlan0_ipv6=\"inet6 accept_rtadv\"" >> etc/rc.conf
    echo "ntpd_enable=\"YES\"" >> etc/rc.conf
    echo "ntpd_sync_on_start=\"YES\"" >> etc/rc.conf
    echo "net.inet6.ip6.use_tempaddr=1" >> etc/sysctl.conf
    echo "net.inet6.ip6.prefer_tempaddr=1" >> etc/sysctl.conf
    echo "network={" >> etc/wpa_supplicant.conf
    echo "    ssid=\"ssid_goes_here\"" >> etc/wpa_supplicant.conf
    echo "    psk=\"psk_goes_here\"" >> etc/wpa_supplicant.conf
